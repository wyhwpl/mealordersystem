...
*/
    ...
    public int changepwd(String sellerid, String newpwd) {
        Seller seller = sellerMapper.selectByPrimaryKey(sellerid);
        seller.setPassword(DigestUtils.md5DigestAsHex(newpwd.getBytes()));
