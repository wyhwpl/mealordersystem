$(function () {
    ...
    var $pageUl=$(".page-breadcrumb .navli");
    ...
    $.ajax({
        ...
        success:function (result) {
            ...
            if(result.applicationtime!=null){
                ...
                var month=(regtime.getMonth()+1)<10?("0"+(regtime.getMonth()+1)):(regtime.getMonth()+1);
                var day=regtime.getDate()<10?("0"+regtime.getDate()):regtime.getDate();
                // var regtimeYMD=regtime.getFullYear()+"-"+(regtime.getMonth()+1)<10?("0"+(regtime.getMonth()+1)):(regtime.getMonth()+1)+"-"+regtime.getDate()<10?("0"+regtime.getDate()):regtime.getDate();
                var regtimeYMD=year+"-"+month+"-"+day;
                var hour=regtime.getHours()<10?("0"+regtime.getHours()):regtime.getHours();
                var minute=regtime.getMinutes()<10?("0"+regtime.getMinutes()):regtime.getMinutes();
                var second=regtime.getSeconds()<10?("0"+regtime.getSeconds()):regtime.getSeconds();
                // var regtimeHMS=regtime.getHours()+":"+regtime.getMinutes()+":"+regtime.getSeconds();
                var regtimeHMS=hour+":"+minute+":"+second;
...
*/
                var year=thoughtime.getFullYear();
                var month=(thoughtime.getMonth()+1)<10?("0"+(thoughtime.getMonth()+1)):(thoughtime.getMonth()+1);
                var day=thoughtime.getDate()<10?("0"+thoughtime.getDate()):thoughtime.getDate();
                // var regtimeYMD=regtime.getFullYear()+"-"+(regtime.getMonth()+1)<10?("0"+(regtime.getMonth()+1)):(regtime.getMonth()+1)+"-"+regtime.getDate()<10?("0"+regtime.getDate()):regtime.getDate();
                var thoughtimeYMD=year+"-"+month+"-"+day;
                var hour=thoughtime.getHours()<10?("0"+thoughtime.getHours()):thoughtime.getHours();
                var minute=thoughtime.getMinutes()<10?("0"+thoughtime.getMinutes()):thoughtime.getMinutes();
                var second=thoughtime.getSeconds()<10?("0"+thoughtime.getSeconds()):thoughtime.getSeconds();
                // var regtimeHMS=regtime.getHours()+":"+regtime.getMinutes()+":"+regtime.getSeconds();
                var thoughtimeHMS=hour+":"+minute+":"+second;
            ...
            if(result.undercarriagetime!=null){
               ...
               /* var logouttimeYMD=logouttime.getFullYear()+"-"+logouttime.getMonth()+"-"+logouttime.getDate();
                ...
                var year=logouttime.getFullYear();
                var month=(logouttime.getMonth()+1)<10?("0"+(logouttime.getMonth()+1)):(logouttime.getMonth()+1);
                var day=logouttime.getDate()<10?("0"+logouttime.getDate()):logouttime.getDate();
                // var regtimeYMD=regtime.getFullYear()+"-"+(regtime.getMonth()+1)<10?("0"+(regtime.getMonth()+1)):(regtime.getMonth()+1)+"-"+regtime.getDate()<10?("0"+regtime.getDate()):regtime.getDate();
                var logouttimeYMD=year+"-"+month+"-"+day;
                var hour=logouttime.getHours()<10?("0"+logouttime.getHours()):logouttime.getHours();
                var minute=logouttime.getMinutes()<10?("0"+logouttime.getMinutes()):logouttime.getMinutes();
                var second=logouttime.getSeconds()<10?("0"+logouttime.getSeconds()):logouttime.getSeconds();
                // var regtimeHMS=regtime.getHours()+":"+regtime.getMinutes()+":"+regtime.getSeconds();
                var logouttimeHMS=hour+":"+minute+":"+second;
        ...
        success:function (result) {
            ...
            if(sta==0){
                ...
                var oprow='<div class="row oprow">' +
                          ...
                          '<button type="button" class="btn btn-primary btn-top" data-ids="'+
